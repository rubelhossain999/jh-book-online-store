...
const AddProductForm = ({ handleaddnewBook, verifiedUser }) => {
    console.log(handleaddnewBook);
        ...
        <div>
            {
                verifiedUser.verified ?
                            ...
                            <form onSubmit={handleaddnewBook} className="space-y-12 ng-untouched ng-pristine ng-valid mt-5">
                                ...
                                sellersdatafromdash?.map(sellersdatafromdash =>
                                    ...
                                    <div>
                                        ...
                                        <input type="email" defaultValue={verifiedUser?.email} disabled name="email" id="email" placeholder="Email Address" className="w-full px-3 py-2 border rounded-md border-gray-700 bg-white text-black" required />
                                    </div>
                                </div>
                    ...
                    <>
                        <h1>User must be verified by admin first</h1>
                    </>
