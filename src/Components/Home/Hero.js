            ...
            <div className="max-w-[1340px] mx-auto flex flex-col justify-center sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
                <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-2xl lg:text-left">
                    ...
                    <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
                        <Link rel="noopener noreferrer" to="/" className="px-8 py-3 text-lg font-semibold rounded bg-secondary text-white">Categories</Link>
                        <Link rel="noopener noreferrer" to="/" className="px-8 py-3 text-lg font-semibold border rounded border-gray-100">Free Book</Link>
                    </div>
                </div>
